<div>
    ...
    <div class="card-body max-w-[85rem] px-4 py-2 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <div class="w-full flex justify-center">
        <img src="{{ asset('storage/iklan.jpg') }}" alt="Iklan"
            class="w-full max-w-full h-[200px] object-cover rounded-lg shadow-md">
    </div>
</div>
